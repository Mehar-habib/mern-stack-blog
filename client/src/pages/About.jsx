      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Habibian Blog! This blog was created by Mehar Habib as
              a personal project to share his thoughts and ideas with the world.
              Mehar Habib is a passionate developer who loves to write about
            ...
            <p>
              ...
              programming languages. Mehar Habib is always learning and
